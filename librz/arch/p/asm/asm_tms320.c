...
static char *tms320_mnemonics(const RzAsm *a, int id, bool json) {
	...
	char *ret = NULL;
	if (id >= 0) {
		const char *m = id < (int)rz_pvector_len(mnems) ? rz_pvector_at(mnems, id) : NULL;
...
RzAsmPlugin rz_asm_plugin_tms320 = {
	.name = "tms320",
	.arch = "tms320",
	.cpus = "c54x,c55x,c55x+,c62x,c64x,c67x,c674x,c66x",
	.desc = "Texas Instruments TMS320 DSP family (c54x,c55x,c55x+,c6x) disassembler",
	.license = "LGPL3",
	.bits = 32,
